  ...
  return (
    <header className="bg-slate-900">
      ...
      >
        ...
        <Popover.Group className="hidden lg:flex lg:flex-1 lg:justify-start lg:gap-x-14">
          {/* <Popover className="relative"> */}
          {/* <Popover.Button className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-red-400">
              Product
              <ChevronDownIcon
