...
import { clearTodo } from '../store/todo/todoSlice'
...
export default function Headers() {
  ...
  useEffect(() => {
    ...
    if (!isToken && location.pathname !=="/login" && location.pathname !=="/signup")  {
      onClickLogout();
    }
  }, [location, status])
  const onClickLogout = () => {
    ...
    <header className="bg-white">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-12">
          ...
          <Link 
          to="/me" className="text-sm font-semibold leading-6 text-gray-900">
            Me
          </Link>
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <button onClick = {onClickLogout} className="text-sm font-semibold leading-6 text-gray-900"
          >
